    ...
    settings = {
      ...
      bind =
        [
          ...
          "$mod, O, movewindow, mon:DP-1"       
          "$mod, I, movewindow, mon:DP-2"
	  ...
	  "$mod, C, killactive"
          ...
          "$mod, Delete, exec, ${pkgs.grimblast}/bin/grimblast copy area"
          "$mod, V, exec, ${pkgs.grimblast}/bin/grimblast copy output"
          "$mod, F, exec, thunar"
	  "$mod, B, exec, firefox"
	]
        ++ (
